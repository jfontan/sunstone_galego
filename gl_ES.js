...
locale={
    ...
    "This will shutdown the selected VMs":"Apagaranse as VMs seleccionadas",
    "This will suspend the selected VMs":"Suspenderanse as VMs seleccionads",
    "Type":"Tipo",
    "Type of file system to be built. This can be any value understood by mkfs unix command.":"Tipo de sistema de ficheiros para xerar. Este pode ser calquera que sexa entendido polo comando unix mkfs.",
    "Type of the image":"Tipo de imaxe",
    "Unauthorized":"Non autorizado",
    "Unpublish":"Retirar autorización",
    "Update":"Modificar",
    "Update template":"Modificar modelo",
    "Used leases":"Leases usadas",
    "Useful links":"Enlaces útiles",
    "Virtual Machine information":"Información da Máquina Virtual",
    "virtual machines":"máquinas virtuais",
    "Virtual Network":"Rede Virtual",
    "Virtual Network information":"Información da Rede Virtual",
    "Virtual Network name missing!":"¡Falta o nome da Rede Virtual!",
    "VM information":"Información da VM",
    "VM Name":"Nome da VM",
    "VNC connection":"Conexión VNC",
    "VNC Disabled":"VNC desctivado",
    "Welcome":"Benvido",
    "Welcome to OpenNebula Self-Service":"Benvido a OpenNebula Self-Service",
    "You can add new storages by clicking \'new\'. Image files will be uploaded to OpenNebula and set ready to be used.":"Podes engadir mais almacenamento pinchando \'novo\'. Os ficheiros de imaxe serán subidos a OpenNebula listos para ser usados.",
    "You can also manage compute resources and perform actions such as stop, resume, shutdown or cancel.":"Tamen podes administrar os teus recursos de computación e facer accións coma parar, continuar, apagar ou cancelar.",
    "You have to confirm this action.":"Tes que confirmar esta acción",
    "You must select a file to upload":"Tes que escoller un fichero que subir",
    "You must specify a name":"Tes que precisar un nome",
    "You must specify size and FS type":"Tes que precisar un tamaño e un tipo de sistema de ficheiros",
    "You need to select something.":"Tes que escoller algunha opción",
    "Your compute resources connectivity is performed using pre-defined virtual networks. You can create and manage these networks using OpenNebula Self-Service.":"A conectividade dos teus recursos de computación faise usando unhas redes virtuais predefinidas. Podes crear e administrar estas redes usando OpenNebula Self-Service.",
};
